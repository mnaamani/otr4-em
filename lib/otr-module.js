...
(function () {
     ...
     */
    var root, otr, OTRBindings, util, events;
    ...
    POLICY.VERSION_MASK = POLICY.ALLOW_V1 | POLICY.ALLOW_V2 | POLICY.ALLOW_V3;
    POLICY.OPPORTUNISTIC = POLICY.VERSION_MASK | POLICY.SEND_WHITESPACE_TAG | POLICY.WHITESPACE_START_AKE |
        POLICY.ERROR_START_AKE;
    POLICY.MANUAL = POLICY.VERSION_MASK;
    POLICY.ALWAYS = POLICY.VERSION_MASK | POLICY.REQUIRE_ENCRYPTION | POLICY.WHITESPACE_START_AKE |
        POLICY.ERROR_START_AKE;
    POLICY.DEFAULT = POLICY.OPPORTUNISTIC;
    ...
    function otrEventHandler(otrSession) {
        ...
        return (function (o) {
            ...
            case "still_secure":
                ...
                return;
            case "msg_event":
                if (o.event === MSGEVENT.RCVDMSG_UNENCRYPTED) {
